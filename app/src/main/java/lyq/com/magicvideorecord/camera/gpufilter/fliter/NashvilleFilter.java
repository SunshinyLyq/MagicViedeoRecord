 ...
 * @desc
 */
public class NashvilleFilter extends GPUImageFilter {

    private int[] vTexture = {-1};
    private int[] vTextureLocation = {-1};

    public NashvilleFilter() {
        super(R.raw.gpu_base_vertex,R.raw.nashville);
    }
    ...
    protected void onInitialized() {
        ...
        runOnDraw(new Runnable() {
            @Override
            public void run() {
                vTexture[0] = OpenGLUtils.loadTexture(MyApplication.getContext(), "filter/nashvillemap.png");
            }
        });
    }
}
