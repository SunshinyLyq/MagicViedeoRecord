 ...
 * @desc
 */
public class HudsonFilter extends GPUImageFilter {

    private int[] vTexture = {-1, -1, -1};
    private int[] vTextureLocation = {-1, -1, -1};
    private int mGLStrengthLocation;

    public HudsonFilter() {
        super(R.raw.gpu_base_vertex,R.raw.hudson);
    }
    ...
    protected void onInitialized() {
        ...
        runOnDraw(new Runnable() {
            @Override
            public void run() {
                vTexture[0] = OpenGLUtils.loadTexture(MyApplication.getContext(), "filter/hudsonbackground.png");
                vTexture[1] = OpenGLUtils.loadTexture(MyApplication.getContext(), "filter/overlaymap.png");
                vTexture[2] = OpenGLUtils.loadTexture(MyApplication.getContext(), "filter/hudsonmap.png");
            }
        });
    }
}
